...
public class RevisionesEspecializadasMedicamento implements Medicamentos{
    ...
    public RevisionesEspecializadasMedicamento(int medicamento_id, String nombre_medicamento,
                                               String descripcion_medicamento, int diagnostico_id, String dosis, String frecuencia, int afiliado_id) {
