...
public class RevisionesEspecializadasDiagnostico implements Diagnosticos{
    ...
    public RevisionesEspecializadasDiagnostico(int diagnostico_id, String descripcion_diagnostico, int cita_id,
                                               int examen_id, int medico_id, String fecha_diagnostico, int afiliado_id) {
