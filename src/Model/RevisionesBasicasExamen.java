...
public class RevisionesBasicasExamen implements Examenes {
    ...
    public RevisionesBasicasExamen(int examen_id, String nombre_examen, String descripcion_examen, String fecha_examen,
